...
static void hwqueue_test_notify_irq(void *arg)
{
	...
	pr_info("test3: popped desc %p, size %d\n", desc, desc_size);
...
static int __init hwqueue_test(void)
{
	...
	pr_info("popped desc from qpool %p, size %d\n", desc, desc_size);
	ctx.desc = desc;
	...
	pr_info("test1: pushed desc %p, size %d\n", desc, desc_size);
	...
	pr_info("test1: popped desc %p, size %d\n", desc, desc_size);
	...
	pr_info("test2: pushed desc %p, size %d\n", desc, desc_size);
	...
	pr_info("test2: popped desc %p, size %d\n", desc, desc_size);
	...
	pr_info("test3: pushing desc %p, size %d\n", desc, desc_size);
