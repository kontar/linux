...
static int __devinit keystone_mdiox_probe(struct platform_device *pdev)
{
...
static int __devexit keystone_mdiox_remove(struct platform_device *pdev)
{
	struct device *dev = &pdev->dev;
...
static struct platform_driver keystone_mdiox_driver = {
	...
	.remove = __devexit_p(keystone_mdiox_remove),
};
