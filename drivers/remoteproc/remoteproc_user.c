...
static int __devinit uproc_driver_probe(struct platform_device *pdev)
{
...
static int __devexit uproc_driver_remove(struct platform_device *pdev)
{
...
static struct of_device_id __devinitdata uproc_of_match[] = {
...
static struct platform_driver uproc_driver = {
	...
	.remove	= __devexit_p(uproc_driver_remove),
};
