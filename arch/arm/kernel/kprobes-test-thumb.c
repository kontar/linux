...
#define DATA_PROCESSING16(op,val)			\
	...
	TEST_UNSUPPORTED(".inst.n 0x44ff	@ add pc, pc")
...
DONT_TEST_IN_ITBLOCK(
	...
	TEST_UNSUPPORTED(".inst.n 0xba80")
	TEST_UNSUPPORTED(".inst.n 0xbabf")
...
#define TEST_POPPC(code, offset)	\
	...
	TEST("wfi")
	TEST_SUPPORTED("wfe")
	TEST_UNSUPPORTED(".inst.n 0xbf50") /* Unassigned hints */
	TEST_UNSUPPORTED(".inst.n 0xbff0") /* Unassigned hints */
...
CONDITION_INSTRUCTIONS(8,
	...
	TEST_UNSUPPORTED(".inst.n 0xde00")
	TEST_UNSUPPORTED(".inst.n 0xdeff")
...
void kprobe_thumb32_test_cases(void)
{
	...
	TEST_UNSUPPORTED(".inst.w 0xe88f0101	@ stmia	pc, {r0,r8}")
	TEST_UNSUPPORTED(".inst.w 0xe92f5f00	@ stmdb	pc!, {r8-r12,r14}")
	TEST_UNSUPPORTED(".inst.w 0xe8bdc000	@ ldmia	r13!, {r14,pc}")
	TEST_UNSUPPORTED(".inst.w 0xe93ec000	@ ldmdb	r14!, {r14,pc}")
	TEST_UNSUPPORTED(".inst.w 0xe8a73f00	@ stmia	r7!, {r8-r12,sp}")
	TEST_UNSUPPORTED(".inst.w 0xe8a79f00	@ stmia	r7!, {r8-r12,pc}")
	TEST_UNSUPPORTED(".inst.w 0xe93e2010	@ ldmdb	r14!, {r4,sp}")
	...
	TEST_UNSUPPORTED(".inst.w 0xe9ffec04	@ ldrd	r14, r12, [pc, #16]!")
	TEST_UNSUPPORTED(".inst.w 0xe8ffec04	@ ldrd	r14, r12, [pc], #16")
	TEST_UNSUPPORTED(".inst.w 0xe9d4d800	@ ldrd	sp, r8, [r4]")
	TEST_UNSUPPORTED(".inst.w 0xe9d4f800	@ ldrd	pc, r8, [r4]")
	TEST_UNSUPPORTED(".inst.w 0xe9d47d00	@ ldrd	r7, sp, [r4]")
	TEST_UNSUPPORTED(".inst.w 0xe9d47f00	@ ldrd	r7, pc, [r4]")
	...
	TEST_UNSUPPORTED(".inst.w 0xe9efec04	@ strd	r14, r12, [pc, #16]!")
	TEST_UNSUPPORTED(".inst.w 0xe8efec04	@ strd	r14, r12, [pc], #16")
	...
	TEST_UNSUPPORTED(".inst.w 0xe8d1f01f	@ tbh [r1, pc]")
	TEST_UNSUPPORTED(".inst.w 0xe8d1f01d	@ tbh [r1, sp]")
	TEST_UNSUPPORTED(".inst.w 0xe8ddf012	@ tbh [sp, r2]")
...
#define DATA_PROCESSING32_DM(op,val)		\
	...
	TEST_UNSUPPORTED(".inst.w 0xea170f0d	@ tst.w r7, sp")
	TEST_UNSUPPORTED(".inst.w 0xea170f0f	@ tst.w r7, pc")
	TEST_UNSUPPORTED(".inst.w 0xea1d0f07	@ tst.w sp, r7")
	TEST_UNSUPPORTED(".inst.w 0xea1f0f07	@ tst.w pc, r7")
	TEST_UNSUPPORTED(".inst.w 0xf01d1f08	@ tst sp, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf01f1f08	@ tst pc, #0x00080008")

	TEST_UNSUPPORTED(".inst.w 0xea970f0d	@ teq.w r7, sp")
	TEST_UNSUPPORTED(".inst.w 0xea970f0f	@ teq.w r7, pc")
	TEST_UNSUPPORTED(".inst.w 0xea9d0f07	@ teq.w sp, r7")
	TEST_UNSUPPORTED(".inst.w 0xea9f0f07	@ teq.w pc, r7")
	TEST_UNSUPPORTED(".inst.w 0xf09d1f08	@ tst sp, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf09f1f08	@ tst pc, #0x00080008")

	TEST_UNSUPPORTED(".inst.w 0xeb170f0d	@ cmn.w r7, sp")
	TEST_UNSUPPORTED(".inst.w 0xeb170f0f	@ cmn.w r7, pc")
	TEST_P("cmn.w	sp, r",7,0,"")
	TEST_UNSUPPORTED(".inst.w 0xeb1f0f07	@ cmn.w pc, r7")
	TEST(  "cmn	sp, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf11f1f08	@ cmn pc, #0x00080008")

	TEST_UNSUPPORTED(".inst.w 0xebb70f0d	@ cmp.w r7, sp")
	TEST_UNSUPPORTED(".inst.w 0xebb70f0f	@ cmp.w r7, pc")
	TEST_P("cmp.w	sp, r",7,0,"")
	TEST_UNSUPPORTED(".inst.w 0xebbf0f07	@ cmp.w pc, r7")
	TEST(  "cmp	sp, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf1bf1f08	@ cmp pc, #0x00080008")

	TEST_UNSUPPORTED(".inst.w 0xea5f070d	@ movs.w r7, sp")
	TEST_UNSUPPORTED(".inst.w 0xea5f070f	@ movs.w r7, pc")
	TEST_UNSUPPORTED(".inst.w 0xea5f0d07	@ movs.w sp, r7")
	TEST_UNSUPPORTED(".inst.w 0xea4f0f07	@ mov.w  pc, r7")
	TEST_UNSUPPORTED(".inst.w 0xf04f1d08	@ mov sp, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf04f1f08	@ mov pc, #0x00080008")
	...
	TEST_UNSUPPORTED(".inst.w 0xeb0d1d01	@ add sp, sp, r1, asl #4")
	TEST_UNSUPPORTED(".inst.w 0xeb0d0d71	@ add sp, sp, r1, ror #1")
	TEST(  "add.w	r0, sp, #24")
	TEST(  "add.w	sp, sp, #24")
	TEST_UNSUPPORTED(".inst.w 0xeb0d0f01	@ add pc, sp, r1")
	TEST_UNSUPPORTED(".inst.w 0xeb0d000f	@ add r0, sp, pc")
	TEST_UNSUPPORTED(".inst.w 0xeb0d000d	@ add r0, sp, sp")
	TEST_UNSUPPORTED(".inst.w 0xeb0d0d0f	@ add sp, sp, pc")
	TEST_UNSUPPORTED(".inst.w 0xeb0d0d0d	@ add sp, sp, sp")
	...
	TEST_UNSUPPORTED(".inst.w 0xebad1d01	@ sub sp, sp, r1, asl #4")
	TEST_UNSUPPORTED(".inst.w 0xebad0d71	@ sub sp, sp, r1, ror #1")
	TEST_UNSUPPORTED(".inst.w 0xebad0f01	@ sub pc, sp, r1")
	TEST(  "sub.w	r0, sp, #24")
	TEST(  "sub.w	sp, sp, #24")

	TEST_UNSUPPORTED(".inst.w 0xea02010f	@ and r1, r2, pc")
	TEST_UNSUPPORTED(".inst.w 0xea0f0103	@ and r1, pc, r3")
	TEST_UNSUPPORTED(".inst.w 0xea020f03	@ and pc, r2, r3")
	TEST_UNSUPPORTED(".inst.w 0xea02010d	@ and r1, r2, sp")
	TEST_UNSUPPORTED(".inst.w 0xea0d0103	@ and r1, sp, r3")
	TEST_UNSUPPORTED(".inst.w 0xea020d03	@ and sp, r2, r3")
	TEST_UNSUPPORTED(".inst.w 0xf00d1108	@ and r1, sp, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf00f1108	@ and r1, pc, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf0021d08	@ and sp, r8, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf0021f08	@ and pc, r8, #0x00080008")

	TEST_UNSUPPORTED(".inst.w 0xeb02010f	@ add r1, r2, pc")
	TEST_UNSUPPORTED(".inst.w 0xeb0f0103	@ add r1, pc, r3")
	TEST_UNSUPPORTED(".inst.w 0xeb020f03	@ add pc, r2, r3")
	TEST_UNSUPPORTED(".inst.w 0xeb02010d	@ add r1, r2, sp")
	TEST_SUPPORTED(  ".inst.w 0xeb0d0103	@ add r1, sp, r3")
	TEST_UNSUPPORTED(".inst.w 0xeb020d03	@ add sp, r2, r3")
	TEST_SUPPORTED(  ".inst.w 0xf10d1108	@ add r1, sp, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf10d1f08	@ add pc, sp, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf10f1108	@ add r1, pc, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf1021d08	@ add sp, r8, #0x00080008")
	TEST_UNSUPPORTED(".inst.w 0xf1021f08	@ add pc, r8, #0x00080008")

	TEST_UNSUPPORTED(".inst.w 0xeaa00000")
	TEST_UNSUPPORTED(".inst.w 0xeaf00000")
	TEST_UNSUPPORTED(".inst.w 0xeb200000")
	TEST_UNSUPPORTED(".inst.w 0xeb800000")
	TEST_UNSUPPORTED(".inst.w 0xebe00000")

	TEST_UNSUPPORTED(".inst.w 0xf0a00000")
	TEST_UNSUPPORTED(".inst.w 0xf0c00000")
	TEST_UNSUPPORTED(".inst.w 0xf0f00000")
	TEST_UNSUPPORTED(".inst.w 0xf1200000")
	TEST_UNSUPPORTED(".inst.w 0xf1800000")
	TEST_UNSUPPORTED(".inst.w 0xf1e00000")

	TEST_GROUP("Coprocessor instructions")

	TEST_UNSUPPORTED(".inst.w 0xec000000")
	TEST_UNSUPPORTED(".inst.w 0xeff00000")
	TEST_UNSUPPORTED(".inst.w 0xfc000000")
	TEST_UNSUPPORTED(".inst.w 0xfff00000")
	...
	TEST_UNSUPPORTED(".inst.w 0xf20f1f20	@ addw pc, pc, #0x120")
	TEST_UNSUPPORTED(".inst.w 0xf20d1f20	@ addw pc, sp, #0x120")
	TEST_UNSUPPORTED(".inst.w 0xf20f1d20	@ addw sp, pc, #0x120")
	TEST_UNSUPPORTED(".inst.w 0xf2001d20	@ addw sp, r0, #0x120")

	TEST_R("subw	r0,  r",1, VAL1,", #0x123")
	TEST(  "subw	r14, sp, #0xf5a")
	TEST(  "subw	sp, sp, #0x20")
	TEST(  "subw	r7,  pc, #0x888")
	TEST_UNSUPPORTED(".inst.w 0xf2af1f20	@ subw pc, pc, #0x120")
	TEST_UNSUPPORTED(".inst.w 0xf2ad1f20	@ subw pc, sp, #0x120")
	TEST_UNSUPPORTED(".inst.w 0xf2af1d20	@ subw sp, pc, #0x120")
	TEST_UNSUPPORTED(".inst.w 0xf2a01d20	@ subw sp, r0, #0x120")

	TEST("movw	r0, #0")
	TEST("movw	r0, #0xffff")
	TEST("movw	lr, #0xffff")
	TEST_UNSUPPORTED(".inst.w 0xf2400d00	@ movw sp, #0")
	TEST_UNSUPPORTED(".inst.w 0xf2400f00	@ movw pc, #0")

	TEST_R("movt	r",0, VAL1,", #0")
	TEST_R("movt	r",0, VAL2,", #0xffff")
	TEST_R("movt	r",14,VAL1,", #0xffff")
	TEST_UNSUPPORTED(".inst.w 0xf2c00d00	@ movt sp, #0")
	TEST_UNSUPPORTED(".inst.w 0xf2c00f00	@ movt pc, #0")

	TEST_R(     "ssat	r0, #24, r",0,   VAL1,"")
	TEST_R(     "ssat	r14, #24, r",12, VAL2,"")
	TEST_R(     "ssat	r0, #24, r",0,   VAL1,", lsl #8")
	TEST_R(     "ssat	r14, #24, r",12, VAL2,", asr #8")
	TEST_UNSUPPORTED(".inst.w 0xf30c0d17	@ ssat	sp, #24, r12")
	TEST_UNSUPPORTED(".inst.w 0xf30c0f17	@ ssat	pc, #24, r12")
	TEST_UNSUPPORTED(".inst.w 0xf30d0c17	@ ssat	r12, #24, sp")
	TEST_UNSUPPORTED(".inst.w 0xf30f0c17	@ ssat	r12, #24, pc")

	TEST_R(     "usat	r0, #24, r",0,   VAL1,"")
	TEST_R(     "usat	r14, #24, r",12, VAL2,"")
	TEST_R(     "usat	r0, #24, r",0,   VAL1,", lsl #8")
	TEST_R(     "usat	r14, #24, r",12, VAL2,", asr #8")
	TEST_UNSUPPORTED(".inst.w 0xf38c0d17	@ usat	sp, #24, r12")
	TEST_UNSUPPORTED(".inst.w 0xf38c0f17	@ usat	pc, #24, r12")
	TEST_UNSUPPORTED(".inst.w 0xf38d0c17	@ usat	r12, #24, sp")
	TEST_UNSUPPORTED(".inst.w 0xf38f0c17	@ usat	r12, #24, pc")

	TEST_R(     "ssat16	r0, #12, r",0,   HH1,"")
	TEST_R(     "ssat16	r14, #12, r",12, HH2,"")
	TEST_UNSUPPORTED(".inst.w 0xf32c0d0b	@ ssat16	sp, #12, r12")
	TEST_UNSUPPORTED(".inst.w 0xf32c0f0b	@ ssat16	pc, #12, r12")
	TEST_UNSUPPORTED(".inst.w 0xf32d0c0b	@ ssat16	r12, #12, sp")
	TEST_UNSUPPORTED(".inst.w 0xf32f0c0b	@ ssat16	r12, #12, pc")

	TEST_R(     "usat16	r0, #12, r",0,   HH1,"")
	TEST_R(     "usat16	r14, #12, r",12, HH2,"")
	TEST_UNSUPPORTED(".inst.w 0xf3ac0d0b	@ usat16	sp, #12, r12")
	TEST_UNSUPPORTED(".inst.w 0xf3ac0f0b	@ usat16	pc, #12, r12")
	TEST_UNSUPPORTED(".inst.w 0xf3ad0c0b	@ usat16	r12, #12, sp")
	TEST_UNSUPPORTED(".inst.w 0xf3af0c0b	@ usat16	r12, #12, pc")

	TEST_R(     "sbfx	r0, r",0  , VAL1,", #0, #31")
	TEST_R(     "sbfx	r14, r",12, VAL2,", #8, #16")
	TEST_R(     "sbfx	r4, r",10,  VAL1,", #16, #15")
	TEST_UNSUPPORTED(".inst.w 0xf34c2d0f	@ sbfx	sp, r12, #8, #16")
	TEST_UNSUPPORTED(".inst.w 0xf34c2f0f	@ sbfx	pc, r12, #8, #16")
	TEST_UNSUPPORTED(".inst.w 0xf34d2c0f	@ sbfx	r12, sp, #8, #16")
	TEST_UNSUPPORTED(".inst.w 0xf34f2c0f	@ sbfx	r12, pc, #8, #16")

	TEST_R(     "ubfx	r0, r",0  , VAL1,", #0, #31")
	TEST_R(     "ubfx	r14, r",12, VAL2,", #8, #16")
	TEST_R(     "ubfx	r4, r",10,  VAL1,", #16, #15")
	TEST_UNSUPPORTED(".inst.w 0xf3cc2d0f	@ ubfx	sp, r12, #8, #16")
	TEST_UNSUPPORTED(".inst.w 0xf3cc2f0f	@ ubfx	pc, r12, #8, #16")
	TEST_UNSUPPORTED(".inst.w 0xf3cd2c0f	@ ubfx	r12, sp, #8, #16")
	TEST_UNSUPPORTED(".inst.w 0xf3cf2c0f	@ ubfx	r12, pc, #8, #16")

	TEST_R(     "bfc	r",0, VAL1,", #4, #20")
	TEST_R(     "bfc	r",14,VAL2,", #4, #20")
	TEST_R(     "bfc	r",7, VAL1,", #0, #31")
	TEST_R(     "bfc	r",8, VAL2,", #0, #31")
	TEST_UNSUPPORTED(".inst.w 0xf36f0d1e	@ bfc	sp, #0, #31")
	TEST_UNSUPPORTED(".inst.w 0xf36f0f1e	@ bfc	pc, #0, #31")

	TEST_RR(    "bfi	r",0, VAL1,", r",0  , VAL2,", #0, #31")
	TEST_RR(    "bfi	r",12,VAL1,", r",14 , VAL2,", #4, #20")
	TEST_UNSUPPORTED(".inst.w 0xf36e1d17	@ bfi	sp, r14, #4, #20")
	TEST_UNSUPPORTED(".inst.w 0xf36e1f17	@ bfi	pc, r14, #4, #20")
	TEST_UNSUPPORTED(".inst.w 0xf36d1e17	@ bfi	r14, sp, #4, #20")
...
CONDITION_INSTRUCTIONS(22,
	...
	TEST("mrs	r0, cpsr")
	TEST("mrs	r14, cpsr")
	TEST_UNSUPPORTED(".inst.w 0xf3ef8d00	@ mrs	sp, spsr")
	TEST_UNSUPPORTED(".inst.w 0xf3ef8f00	@ mrs	pc, spsr")
	TEST_UNSUPPORTED("mrs	r0, spsr")
	TEST_UNSUPPORTED("mrs	lr, spsr")

	TEST_UNSUPPORTED(".inst.w 0xf7f08000 @ smc #0")

	TEST_UNSUPPORTED(".inst.w 0xf7f0a000 @ undefeined")
...
#define SINGLE_STORE(size)							\
	...
	TEST("str	sp, [sp]")
	TEST_UNSUPPORTED(".inst.w 0xf8cfe000	@ str	r14, [pc]")
	TEST_UNSUPPORTED(".inst.w 0xf8cef000	@ str	pc, [r14]")

	TEST_GROUP("Advanced SIMD element or structure load/store instructions")

	TEST_UNSUPPORTED(".inst.w 0xf9000000")
	TEST_UNSUPPORTED(".inst.w 0xf92fffff")
	TEST_UNSUPPORTED(".inst.w 0xf9800000")
	TEST_UNSUPPORTED(".inst.w 0xf9efffff")
...
#define SINGLE_LOAD(size)						\
	...
	TEST_UNSUPPORTED(".inst.w 0xf854700d	@ ldr	r7, [r4, sp]")
	TEST_UNSUPPORTED(".inst.w 0xf854700f	@ ldr	r7, [r4, pc]")
	TEST_UNSUPPORTED(".inst.w 0xf814700d	@ ldrb	r7, [r4, sp]")
	TEST_UNSUPPORTED(".inst.w 0xf814700f	@ ldrb	r7, [r4, pc]")
	TEST_UNSUPPORTED(".inst.w 0xf89fd004	@ ldrb	sp, 99f")
	TEST_UNSUPPORTED(".inst.w 0xf814d008	@ ldrb	sp, [r4, r8]")
	TEST_UNSUPPORTED(".inst.w 0xf894d000	@ ldrb	sp, [r4]")

	TEST_UNSUPPORTED(".inst.w 0xf8600000") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xf9ffffff") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xf9500000") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xf95fffff") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xf8000800") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xf97ffaff") /* Unallocated space */
	...
	TEST(   ".inst.w 0xf8b0f400	@ pldw	[r0, #1024]")
	TEST_P( "pli	[r",4, 0b,", #1024]")
	TEST_P( "pld	[r",7, 120,", #-120]")
	TEST(   ".inst.w 0xf837fc78	@ pldw	[r7, #-120]")
	TEST_P( "pli	[r",11,120,", #-120]")
	TEST(   "pld	[sp, #0]")

	TEST_PR("pld	[r",7, 24, ", r",0, 16,"]")
	TEST_PR("pld	[r",8, 24, ", r",12,16,", lsl #3]")
	TEST_SUPPORTED(".inst.w 0xf837f000	@ pldw	[r7, r0]")
	TEST_SUPPORTED(".inst.w 0xf838f03c	@ pldw	[r8, r12, lsl #3]");
	TEST_RR("pli	[r",12,0b,", r",0, 16,"]")
	TEST_RR("pli	[r",0, 0b,", r",12,16,", lsl #3]")
	TEST_R( "pld	[sp, r",1, 16,"]")
	TEST_UNSUPPORTED(".inst.w 0xf817f00d  @pld	[r7, sp]")
	TEST_UNSUPPORTED(".inst.w 0xf817f00f  @pld	[r7, pc]")
...
#define SHIFTS32(op)					\
	...
	TEST_UNSUPPORTED(".inst.w 0xfa01ff02	@ lsl	pc, r1, r2")
	TEST_UNSUPPORTED(".inst.w 0xfa01fd02	@ lsl	sp, r1, r2")
	TEST_UNSUPPORTED(".inst.w 0xfa0ff002	@ lsl	r0, pc, r2")
	TEST_UNSUPPORTED(".inst.w 0xfa0df002	@ lsl	r0, sp, r2")
	TEST_UNSUPPORTED(".inst.w 0xfa01f00f	@ lsl	r0, r1, pc")
	TEST_UNSUPPORTED(".inst.w 0xfa01f00d	@ lsl	r0, r1, sp")

	TEST_RR(    "sxtah	r0, r",0,  HH1,", r",1, HH2,"")
	TEST_RR(    "sxtah	r14,r",12, HH2,", r",10,HH1,", ror #8")
	TEST_R(     "sxth	r8, r",7,  HH1,"")

	TEST_UNSUPPORTED(".inst.w 0xfa0fff87	@ sxth	pc, r7");
	TEST_UNSUPPORTED(".inst.w 0xfa0ffd87	@ sxth	sp, r7");
	TEST_UNSUPPORTED(".inst.w 0xfa0ff88f	@ sxth	r8, pc");
	TEST_UNSUPPORTED(".inst.w 0xfa0ff88d	@ sxth	r8, sp");
	...
	TEST_UNSUPPORTED(".inst.w 0xfa6000f0")
	TEST_UNSUPPORTED(".inst.w 0xfa7fffff")
...
#define PARALLEL_ADD_SUB(op)					\
	...
	TEST_UNSUPPORTED(".inst.w 0xfa9cff8c	@ rev	pc, r12");
	TEST_UNSUPPORTED(".inst.w 0xfa9cfd8c	@ rev	sp, r12");
	TEST_UNSUPPORTED(".inst.w 0xfa9ffe8f	@ rev	r14, pc");
	TEST_UNSUPPORTED(".inst.w 0xfa9dfe8d	@ rev	r14, sp");
	...
	TEST_UNSUPPORTED(".inst.w 0xfa80f030") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xfaffff7f") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xfab0f000") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xfaffff7f") /* Unallocated space */
	...
	TEST_UNSUPPORTED(".inst.w 0xfb08ff09	@ mul	pc, r8, r9")
	TEST_UNSUPPORTED(".inst.w 0xfb08fd09	@ mul	sp, r8, r9")
	TEST_UNSUPPORTED(".inst.w 0xfb0ff709	@ mul	r7, pc, r9")
	TEST_UNSUPPORTED(".inst.w 0xfb0df709	@ mul	r7, sp, r9")
	TEST_UNSUPPORTED(".inst.w 0xfb08f70f	@ mul	r7, r8, pc")
	TEST_UNSUPPORTED(".inst.w 0xfb08f70d	@ mul	r7, r8, sp")

	TEST_RRR(   "mla	r0, r",1, VAL1,", r",2, VAL2,", r",3,  VAL3,"")
	TEST_RRR(   "mla	r7, r",8, VAL3,", r",9, VAL1,", r",10, VAL2,"")
	TEST_UNSUPPORTED(".inst.w 0xfb08af09	@ mla	pc, r8, r9, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb08ad09	@ mla	sp, r8, r9, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb0fa709	@ mla	r7, pc, r9, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb0da709	@ mla	r7, sp, r9, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb08a70f	@ mla	r7, r8, pc, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb08a70d	@ mla	r7, r8, sp, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb08d709	@ mla	r7, r8, r9, sp");
	...
	TEST_UNSUPPORTED(".inst.w 0xfb00f010") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xfb0fff1f") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xfb70f010") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xfb7fff1f") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xfb700010") /* Unallocated space */
	TEST_UNSUPPORTED(".inst.w 0xfb7fff1f") /* Unallocated space */
	...
	TEST_UNSUPPORTED(".inst.w 0xfb89f80a	@ smull	pc, r8, r9, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb89d80a	@ smull	sp, r8, r9, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb897f0a	@ smull	r7, pc, r9, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb897d0a	@ smull	r7, sp, r9, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb8f780a	@ smull	r7, r8, pc, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb8d780a	@ smull	r7, r8, sp, r10");
	TEST_UNSUPPORTED(".inst.w 0xfb89780f	@ smull	r7, r8, r9, pc");
	TEST_UNSUPPORTED(".inst.w 0xfb89780d	@ smull	r7, r8, r9, sp");
	...
	TEST_UNSUPPORTED(".inst.w 0xfc000000")
	TEST_UNSUPPORTED(".inst.w 0xffffffff")
